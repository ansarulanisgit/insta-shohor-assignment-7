...
const displayLikedPosts = () => {
  document.getElementById( "liked-post" ).textContent = '';
...
const displayReportedPosts = () => {
  document.getElementById( "reported-post" ).textContent = '';
...
const loadPosts = async () =>{
  let data = await fetch('https://raw.githubusercontent.com/ansarulanisgit/insta-shohor-assignment-7/main/data/posts.json');
